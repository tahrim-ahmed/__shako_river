...
//	$slab_id, $slab_gift, $r_total_next, $slab_id_next, $slab_gift_next,
    ...
    if (isset($_POST['search'])) {
        ...
        $sql10 = "SELECT SUM(i_amount) as own FROM invoice4 WHERE d_check='yes' and r_code='$r_code'";
        $sql11 = "SELECT SUM(i_amount) as other FROM invoice4 WHERE d_check='no' and r_code='$r_code'";
        $sql12 = "SELECT count(id) as count FROM invoice4 WHERE r_code='$r_code'";
...
//Slab Calculation
        ...
        $sql20 = "SELECT * FROM slab3 WHERE '$r_own' BETWEEN a_start and a_end";
        ...
        //next Slab
        $sql21 = "SELECT * FROM slab3 WHERE c_slab='$n_slab'";
        ...
        $sql = "SELECT * FROM `new_retailer` r,`new_distributor` d,`fa` f WHERE r.`r_code`='$r_code' AND r.`d_code`=d.`d_code` AND r.`f_code`=f.`f_code`";
    ...
    if (isset($_POST["submit"])) {
        ...
        //$error = $_POST['error'];
        $sql3 = "SELECT r_code,date,memo_no,i_amount FROM invoice4 WHERE r_code='$r_code'AND date='$date'AND memo_no='$memo_no' AND i_amount='$i_amount'";


        $sql2 = "INSERT INTO invoice4 (r_code, d_check, date, memo_no, i_amount, p_amount,Remarks, entry, user, status, error)
VALUES ('$r_code', '$d_check','$date','$memo_no', '$i_amount', '$p_amount', '$remarks', '$entry','$name','$status','$error' )";
        ...
        $sql22 = "SELECT * FROM `new_retailer` r,`new_distributor` d,`fa` f WHERE r.`r_code`='$r_code' AND r.`d_code`=d.`d_code` AND r.`f_code`=f.`f_code`";
    ...
    if (isset($_POST["missing"])) {
        ...
        $find = "SELECT r_cell FROM new_retailer WHERE r_code = '$r_code'";
        ...
        if (mysqli_num_rows($findResult) > 0) {
            while ($row = mysqli_fetch_assoc($findResult)) {
                ...
                if (strlen($r_cell) < 10) {
                    $sql3 = "SELECT r_code FROM missing WHERE r_code='$r_code'";


                    $sql2 = "INSERT INTO missing (r_code) VALUES ('$r_code')";
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page" style="color:DodgerBlue;">Jul-Dec 2021</li>
        </ol>
    </nav>
        ...
        <div class="table-responsive-sm">
                        ...
                        <div class="card">
                            ...
                            <fieldset>
                                ...
                                <table class="table table-sm table-striped table-bordered">
                                    ...
                                    <tr>
                                        <td colspan="">Current Slab Gift:</td>
                                        <td><strong><?php echo $gift; ?></strong></td>
                                        <td colspan="">Add. Gift Amount:</td>
                                        <td><strong><?php echo $a_g_amount; ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="">Additional Gift:</td>
                                        <td><strong><?php echo $a_gift; ?></strong></td>
                                        <td colspan="">Next Slab Amount:</td>
                                        <td><strong><?php echo $n_slab_amount; ?></strong></td>
                                    </tr>

                                    <tr>
                                        <td>Total Gift Amount:</td>
                                        <td><strong><?php echo $t_gift; ?></strong></td>
                                        <td>Next Slab Gift:</td>
                                        <td><strong><?php echo $n_slab_gift; ?></strong></td>
                            ...
                            <fieldset>
                                ...
                                <table class="table table-sm table-borderless">
                                    <form id="search_data" method="POST">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class=" typeahead tt-query" autocomplete="off"
                                                       spellcheck="false" name="typeahead"
                                    ...
                                    <form id="add_data" method="POST">
                                        ...
                                        <tr>
                                            <td>Date:</td>
                                            <td><input class="form-control form-control-sm" type="Date" name="date"
                                                       required></td>
                                        </tr>
                                        <tr>
                                            <td>Memo No.:</td>
                                            <td><input class="form-control form-control-sm" type="text" name="memo_no"
                                                       required></td>
                                        </tr>

                                        <tr>
                                            <td>invoice Amount:</td>
                                            <td><input class="form-control form-control-sm" type="text" name="i_amount"
                                                       required></td
                                        </tr>

                                        <tr>
                                            <td>Paid Amount:</td>
                                            <td><input class="form-control form-control-sm" type="text" name="p_amount">
                                            </td
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="entry"
                                                           name="entry" value="no">
                                                    <label style="color: blue;" class="custom-control-label"
                                                           for="entry">NO</label>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <form action="" method="post">
                                    ...
                                    <tr>
                                        <td colspan="3" style="text-align: center;">
                                            <input class="btn btn-success btn-sm btn-block" type="submit" name="missing"
                            ...
                            <fieldset>
                                ...
                                <table class="table table-sm table-hover table-bordered">
                                    ...
                                    if (isset($_POST['search'])) {
                                        ...
                                        $sql4 = "SELECT * FROM `invoice4` WHERE `r_code`='$r_code'";
			...
			";
                                                if ($row['status'] == "Verified" && $_SESSION['type'] == "user") {
                                                    ...
                                                    echo "<td>
				<a href='add_data4.php?eid={$row['id']}'><i class='fas fa-edit' style='font-size:20px;color:blue;'></i></a> &nbsp
				<a href='add_data4.php?did={$row['id']}'><i class='fas fa-trash-alt' style='font-size:20px;color:red;'></i></a> &nbsp&nbsp
				<a href='add_data4.php?vid={$row['id']}'><i class='fas fa-check-square' style='font-size:21px;color:green;'></i></a>
			</td>";
                                                }
			...
			";
                                                if ($row['status'] == "Verified") {
                                                    ...
                                                    echo "<td>
				<a href='add_data3.php?eid={$row['id']}'><i class='fas fa-edit' style='font-size:20px;color:blue;'></i></a> &nbsp
				<a href='add_data3.php?did={$row['id']}'><i class='fas fa-trash-alt' style='font-size:20px;color:red;'></i></a> &nbsp&nbsp
				<a href='add_data3.php?vid={$row['id']}'><i class='fas fa-check-square' style='font-size:21px;color:green;'></i></a>
			</td>";
                                                }
                                    ...
                                    if (isset($_GET['did'])) {
                                        $del = $_GET['did'];
                                        $sql3 = "DELETE FROM invoice4 WHERE id='$del'";
                                        mysqli_query($conn, $sql3);
                                        echo "	<script type='text/javascript'>
			alert('invoice4 $del; Delete Successful');
			window.location = 'add_data4.php';
		</script>";
                                    }
	...
	<tr>
		...
		<input type='submit' name='update' class='btn btn-success' value='Update'>
                                        ...
                                        if (isset($_POST["update"])) {
                                            ...
                                            $sql5 = "UPDATE invoice4 SET d_check='{$e_d_check}', date ='{$e_date}', memo_no='{$e_memo_no}', i_amount= '{$e_i_amount}', p_amount= '{$e_p_amount}', remarks= '{$e_remarks}', entry= '{$e_entry}',error= '{$e_error}', user= '{$e_name}', status= '{$e_status}'WHERE id='{$e_id}'";
                                            $update = mysqli_query($conn, $sql5);
                                            echo "<script type='text/javascript'>
			alert('invoice4:$edit;Update Successful.');
			window.location = 'add_data4.php';
		</script>";
                                    ...
                                    if (isset($_GET['vid'])) {
                                        ...
                                        $v_status = "Verified";
                                        $sql6 = "UPDATE invoice4 SET status='{$v_status}', user='{$v_name}' WHERE id='{$verify}'";
                                        $result6 = mysqli_query($conn, $sql6);
                                        echo "<script type='text/javascript'>
	alert('invoice4:$verify; Verified');
	window.location = 'add_data4.php';
	</script>";
