...
//	$slab_id, $slab_gift, $r_total_next, $slab_id_next, $slab_gift_next,
    ...
    $query = "SELECT distributor2.*, duplicate_distributor.* FROM distributor2 INNER JOIN duplicate_distributor ON distributor2.d_code = duplicate_distributor.di_code";
        ...
        <table id="fa_data" class="table table-striped table-bordered">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td><?=$row["d_status"]?></td>
                    <td>
                        <a href="distributorDuplicate_delete.php?ID=<?= $row["d_code"]?>" class="btn btn-danger btn-circle btn-sm">
