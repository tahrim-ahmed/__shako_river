...
//	$slab_id, $slab_gift, $r_total_next, $slab_id_next, $slab_gift_next,
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">TDO</li>
	</ol>
        ...
        <table id="fa_data" class="table table-striped table-bordered">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td><?='0'.$row["f_cell"]?></td>
                    <td><?=$row["f_status"]?></td>
                    <td><a href="fa_edit.php?ID=<?= $row["f_code"]?>" class="btn btn-info btn-circle btn-sm">
                            <i class="fas fa-pen"></i>
                        </a>&nbsp; &nbsp;
                        <a href="fa_delete.php?ID=<?= $row["f_code"]?>" class="btn btn-danger btn-circle btn-sm">
